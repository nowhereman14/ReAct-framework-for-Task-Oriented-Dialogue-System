...
if __name__ == "__main__":
    ...
    intents = ['REQUEST:GET', 'ASK:GET', 'INFORM:GET', 'INFORM:FALLBACK', 'INFORM:REFINE', 'REQUEST:BOOK', 'REQUEST:COMPARE']
    ...
    for intent in intents:
        ...
        print(f"=== FINAL METRICS (per-instance aggregated) FOR {intent}===")
        print(f"Total: {i}")
